        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(photoFile == null || ivPic.getDrawable() == null){
                    Toast.makeText(PostActivity.this, "Must take a photo before posting", Toast.LENGTH_SHORT).show();
                } else {
        ...
        newPost.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(PostActivity.this, "One or more fields incomplete.", Toast.LENGTH_SHORT).show();
